...
<?php 
	$package_name_s=isset($_POST['package_name_s'])?$_POST['package_name_s']:'';
	if(!$package_name_s&&isset($_GET['package_name_s'])&&$_GET['package_name_s']!==''){
		$package_name_s=$_GET['package_name_s'];
	}
?>

<form method="post">
	<div class="lbsearch">
	 <input type="text" name="package_name_s" placeholder="搜索礼包" class="lb_search_tx" value="<?php echo $package_name_s?>">
    ...
    <div >
        ...
        $list = $this->getLibaoList($this->libaoPageSize, 1,$package_name_s);
            ...
            $(function () {
                ...
                function ajaxidxmore(obj) {
                    ...
                    if (!isNaN(page)) {
                        ...
                        unlock = false;
                        var package_name_s = '<?php echo $package_name_s ?>';
