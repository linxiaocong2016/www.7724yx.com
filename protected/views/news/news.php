...
<div class="public clearfix">
    ...
    <div class="detail">   
        <div class="news_tit"><a href="http://www.7724.com/online/<?php echo $lvInfo['game_id'] ?>/"><?php echo $lvInfo['game_name'] ?></a>&gt;<a href="http://www.7724.com/index/news/id/<?php echo $_GET['id']; ?>">新闻</a>&gt; 正文</div>
        <div class="detail_text">
            ...
            <p class="next_pre">
                <?php if($news['previd']) { ?>
                    <a href="http://www.7724.com/index/news/id/<?php echo $news['previd']; ?>">上一篇：<?php echo $news['prevtitle']; ?></a>					
                <?php } ?>
                <?php if($news['nextid']) { ?>
                    <a href="http://www.7724.com/index/news/id/<?php echo $news['nextid']; ?>">下一篇：<?php echo $news['nexttitle']; ?></a>
                <?php } ?>
