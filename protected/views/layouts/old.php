...
<header>
	<div class="logo">
		<a href="/wy/" class="a1"><img
			src="/img/7724logo.png" /></a>
        
                    <a href="/search/" id="asearch" class="a2"><img
...
<nav>
	<ul class="7724_nav">
		<li ><a href="http://online.7724.com/">在线</a></li>
		<li <?php echo $_GET['alias'] == 'dj' ? 'class="hover"' : '';?>><a href="<?php echo $this->createUrl('old/list',array('alias'=>'dj'));?>">单机</a></li>
		<li <?php echo $_GET['alias'] == 'wy' ? 'class="hover"' : '';?>><a href="<?php echo $this->createUrl('old/list',array('alias'=>'wy'));?>">网游</a></li>
		<li <?php echo $_GET['alias'] == 'crack' ? 'class="hover"' : '';?>><a href="<?php echo $this->createUrl('old/list',array('alias'=>'crack'));?>">破解</a></li>
     </ul>
</nav>
<?php echo $content;?>
<!--底部-->
