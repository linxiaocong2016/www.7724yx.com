...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var files = $(".files");
        var btn = $(".btn span");
        $("#head_img").wrap("<form id='myupload' action='/user/EditUpImg' method='post' enctype='multipart/form-data'></form>");
        $("#head_img").change(function () {
            ...
            $("#myupload").ajaxSubmit({
                ...
                success: function (data) {
                    ...
                    if (data.err == "") {
                        var img = "http://img.7724.com/" + data.pic;
                        ...
                        $.post("/user/editimgsave", {img: data.pic}, function (msg) {
                            ...
                            else  alert("头像更新成功！");//percent.html("头像更新成功！");
                        });
                    }
                    else
                    {
...
<form id="frmInfo" method="post" enctype="multipart/form-data">
    ...
    <div class="user_bg <?php echo $info['sex'] == 0 ? "woman_bg" : "man_bg"; ?>">
        <p class="pic">
			...
			<!--			
            <img id="showimg"
                 src="< ?php echo empty($info['head_img']) ? "/img/default_pic.png" : "http://img.7724.com/" . $info['head_img']; ?>">
			-->
        </p>
        ...
        <ul class="input_box2">
            ...
            <li><span>性别：</span>
                <p class="sex">
                    ...
                    <span class="woman<?php echo $info['sex'] == 2 ? " on2" : ""; ?>"><em>女</em></span>
                </p></li>
