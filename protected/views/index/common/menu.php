...
$key = 0;
if($ac == 'new' || $ac == 'top' || $ac == 'gamecatlist') {
	 if($_GET['alias'])
        $key = 6;
    else
       $key = 2;
...
<nav>
    ...
    <ul class="main_nav clearfix">  
			...
			<li <?php if($key == 8) echo 'class="hover"'; ?> style="width:17%;"><a href="/list.html" title="游戏分类">分类</a></li>
			...
			-->
            <li <?php if($key == 3) echo 'class="hover"'; ?> style="width:16%;"><a href="/libao.html" title="游戏礼包">礼包</a></li>
            <!--
