    ...
    <div class="public new_public clearfix">
        <div class="detail_list_one">
            <dl>
                ...
                <dt>
                <p class="p1"><a href="/<?php echo $lvInfo['pinyin'] ?>/"><img src="<?php echo $this->getPic($lvInfo['game_logo']) ?>" /></a></p>

                <p class="p2">
                    <i><a href="/<?php echo $lvInfo['pinyin'] ?>/"><?php echo $lvInfo['game_name'] ?></a></i>
                    <em><?php echo $this->getStarImg($lvInfo['star_level']) ?></em>
                    <span><?php echo $this->getGameTypeName($lvInfo['game_type'], 2,TRUE);?><br>人气：<?php echo $this->getVisits($lvInfo); ?></span>
                </p>
...
<div class="public clearfix">
    <div class="detail">   
        ...
        <div class="detail_text">
            ...
            <p class="time"><?php echo date('Y-m-d', $news['publictime']); ?><em>&nbsp;&nbsp;作者：<?php echo $news['author']; ?></em></p>
