    ...
    <body>
        <table class="table_a" border="1" width="100%">
            ...
            $form = $this->beginWidget('CActiveForm', array(
                ...
                'action' => $this->createUrl("reply/search"),
                'htmlOptions' => array('enctype' => 'multipart/form-data')
            ));
            ?>
            <input type="text" name="keyword" value="" />
            <input type="submit" value="关键字查询">
            <a href="./reply/add"><input type="button" value="新增"></a>
            ...
            <?php foreach ($reply_infos as $_v): ?>
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><a href="./reply/update/reply_id/<?php echo $_v->reply_id; ?>">修改</a>&nbsp;<a href="./reply/del/reply_id/<?php echo $_v->reply_id; ?>">删除</a></td>
                </tr>
                    <?php endforeach; ?>
            <tr>
