...
class PhzhouController extends LController
{
	public $lvTable='game_play_paihang_zhou';
	...
	public function actionIndex(){
		...
		$sql="SELECT id,uid,username,game_id,game_name,score,modifytime,city,pid,sid FROM $table t1 where  $where  $order $limit";
