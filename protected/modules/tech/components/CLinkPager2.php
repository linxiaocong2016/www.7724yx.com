...
class CLinkPager2 extends CBasePager
{
	...
	public function init()
	{
		...
		if(!isset($this->htmlOptions['class']))
			$this->htmlOptions['class']='pull-right pgs';
	}
	...
	protected function createPageButtons()
	{
		...
		if(($page=$currentPage-1)<0)
			$page=0;
		$buttons[]=$this->createPageButtonSpan($this->prevPageLabel,$page,$this->previousPageCssClass,$currentPage<=0,false);
		...
		if(($page=$currentPage+1)>=$pageCount-1)
			$page=$pageCount-1;
		$buttons[]=$this->createPageButtonSpan($this->nextPageLabel,$page,$this->nextPageCssClass,$currentPage>=$pageCount-1,false);

		// last page
		$buttons[]=$this->createPageButtonSpan($this->lastPageLabel,$pageCount-1,$this->lastPageCssClass,$currentPage>=$pageCount-1,false);
...
// 		return CHtml::link($label,$this->createPageUrl($page));
	...
	protected function createPageButtonSpan($label,$page,$class,$hidden,$selected)
	{
