...
*/
	...
	//处理多出的recharge_order_no订单号，不然微信签名验证会失败
	/*
	$doc = DOMDocument::loadXML($xml);
	$root = $doc->documentElement;
	$child = $root->getElementsByTagName_r("recharge_order_no")->item(0);	
	//删除recharge_order_no对象
