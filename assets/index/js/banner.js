...
ScrollPic.prototype = {
  ...
  play : function(){
    ...
    this._autoTimeObj = setInterval(function(){thisTemp.next(true)},this.autoPlayTime * 3000);
  },
  stop : function(){
    clearInterval(this._autoTimeObj);
  },
 ...
 if(document.getElementById("slide_pic")){
	...
	slide_01.scrollContId   = "slide_pic"; //内容容器ID
	slide_01.dotListId      = "slide_num";//点列表ID
	slide_01.dotOnClassName = "on";
	slide_01.arrLeftId      = "sl_left"; //左箭头ID
	slide_01.arrRightId     = "sl_right";//右箭头ID
	slide_01.frameWidth     = Wwidth;
	slide_01.pageWidth      = Wwidth;
